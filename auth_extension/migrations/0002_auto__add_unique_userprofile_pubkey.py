...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserProfile', fields ['pubkey']
        db.create_unique('auth_extension_userprofile', ['pubkey'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['pubkey']
        db.delete_unique('auth_extension_userprofile', ['pubkey'])
    ...
    models = {
        ...
        'auth_extension.userprofile': {
            ...
            'research_groups': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth_extension.ResearchGroup']", 'symmetrical': 'False'}),
        ...
        'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
