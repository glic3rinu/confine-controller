...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CnHost', fields ['cndb_uri']
        db.create_unique(u'communitynetworks_cnhost', ['cndb_uri'])


    def backwards(self, orm):
        # Removing unique constraint on 'CnHost', fields ['cndb_uri']
        db.delete_unique(u'communitynetworks_cnhost', ['cndb_uri'])
