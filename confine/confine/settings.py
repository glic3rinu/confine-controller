...
#WARN: admin_tools keep reliyng on it
...
SECRET_KEY = 'g=z-$qo+7^nk6z4&amp;nvmo&amp;3wbs98mhp&amp;zmynd16-f8mil61ny+x'
...
ROOT_URLCONF = 'confine.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'confine.wsgi.application'
