...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'communitynetworks_cnhost', 'cndb_uri', self.gf('controller.models.fields.URIField')(max_length=200, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'CnHost.cndb_uri'
        db.alter_column(u'communitynetworks_cnhost', 'cndb_uri', self.gf('django.db.models.fields.URLField')(unique=True, max_length=200, null=True))
