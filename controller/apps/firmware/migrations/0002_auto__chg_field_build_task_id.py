...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Build.task_id'
        db.alter_column(u'firmware_build', 'task_id', self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Build.task_id'
        db.alter_column(u'firmware_build', 'task_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=36, unique=True))
