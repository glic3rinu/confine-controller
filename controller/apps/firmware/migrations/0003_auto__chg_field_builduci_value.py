...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BuildUCI.value'
        db.alter_column(u'firmware_builduci', 'value', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'BuildUCI.value'
        db.alter_column(u'firmware_builduci', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))
