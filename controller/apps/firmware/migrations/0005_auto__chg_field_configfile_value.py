...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConfigFile.value'
        db.alter_column(u'firmware_configfile', 'value', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ConfigFile.value'
        db.alter_column(u'firmware_configfile', 'value', self.gf('django.db.models.fields.CharField')(max_length=256))
