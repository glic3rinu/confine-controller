...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConfigFile.priority'
        db.add_column(u'firmware_configfile', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConfigFile.priority'
        db.delete_column(u'firmware_configfile', 'priority')
