...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConfigFile.optional'
        db.delete_column(u'firmware_configfile', 'optional')

        # Adding field 'ConfigFile.is_optional'
        db.add_column(u'firmware_configfile', 'is_optional',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ConfigFile.is_active'
        db.add_column(u'firmware_configfile', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ConfigFile.optional'
        db.add_column(u'firmware_configfile', 'optional',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ConfigFile.is_optional'
        db.delete_column(u'firmware_configfile', 'is_optional')

        # Deleting field 'ConfigFile.is_active'
        db.delete_column(u'firmware_configfile', 'is_active')
    ...
    models = {
        ...
        u'firmware.confighelptext': {
            'Meta': {'object_name': 'ConfigHelpText'},
            'config': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['firmware.Config']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
