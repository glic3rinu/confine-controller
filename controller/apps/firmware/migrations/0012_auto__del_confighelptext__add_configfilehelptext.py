...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ConfigHelpText'
        db.delete_table(u'firmware_confighelptext')

        # Adding model 'ConfigFileHelpText'
        db.create_table(u'firmware_configfilehelptext', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['firmware.Config'])),
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['firmware.ConfigFile'])),
            ('help_text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'firmware', ['ConfigFileHelpText'])


    def backwards(self, orm):
        # Adding model 'ConfigHelpText'
        db.create_table(u'firmware_confighelptext', (
            ('text', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('config', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['firmware.Config'], unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'firmware', ['ConfigHelpText'])

        # Deleting model 'ConfigFileHelpText'
        db.delete_table(u'firmware_configfilehelptext')
    ...
    models = {
        ...
        u'firmware.configfilehelptext': {
            ...
            'config': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['firmware.Config']"}),
            'file': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['firmware.ConfigFile']"}),
