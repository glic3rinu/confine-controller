...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConfigFileHelpText.file'
        db.alter_column(u'firmware_configfilehelptext', 'file_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['firmware.ConfigFile'], unique=True))
        # Adding unique constraint on 'ConfigFileHelpText', fields ['file']
        db.create_unique(u'firmware_configfilehelptext', ['file_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ConfigFileHelpText', fields ['file']
        db.delete_unique(u'firmware_configfilehelptext', ['file_id'])


        # Changing field 'ConfigFileHelpText.file'
        db.alter_column(u'firmware_configfilehelptext', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['firmware.ConfigFile']))
