...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConfigFile.value'
        db.delete_column(u'firmware_configfile', 'value')

        # Adding field 'ConfigFile.content'
        db.add_column(u'firmware_configfile', 'content',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ConfigFile.value'
        db.add_column(u'firmware_configfile', 'value',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=256),
                      keep_default=False)

        # Deleting field 'ConfigFile.content'
        db.delete_column(u'firmware_configfile', 'content')
