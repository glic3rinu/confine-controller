...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'BuildFile', fields ['parent']
        db.delete_unique(u'firmware_buildfile', ['parent_id'])


        # Changing field 'BuildFile.parent'
        db.alter_column(u'firmware_buildfile', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['firmware.ConfigFile']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BuildFile.parent'
        db.alter_column(u'firmware_buildfile', 'parent_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['firmware.ConfigFile'], unique=True))
        # Adding unique constraint on 'BuildFile', fields ['parent']
        db.create_unique(u'firmware_buildfile', ['parent_id'])
    ...
    models = {
        ...
        u'firmware.buildfile': {
            'Meta': {'unique_together': "(('build', 'parent'),)", 'object_name': 'BuildFile'},
            'build': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['firmware.Build']"}),
            'content': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['firmware.ConfigFile']"}),
