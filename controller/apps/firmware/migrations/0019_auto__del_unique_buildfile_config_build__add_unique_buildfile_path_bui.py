...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'BuildFile', fields ['path', 'build']
        db.create_unique(u'firmware_buildfile', ['path', 'build_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BuildFile', fields ['path', 'build']
        db.delete_unique(u'firmware_buildfile', ['path', 'build_id'])
