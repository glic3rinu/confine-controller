...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Config.image_name'
        db.add_column(u'firmware_config', 'image_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Config.image_name'
        db.delete_column(u'firmware_config', 'image_name')
    ...
    models = {
        ...
        u'firmware.config': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'version': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
