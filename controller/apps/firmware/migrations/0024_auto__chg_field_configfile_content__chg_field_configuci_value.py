...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConfigFile.content'
        db.alter_column(u'firmware_configfile', 'content', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ConfigUCI.value'
        db.alter_column(u'firmware_configuci', 'value', self.gf('django.db.models.fields.TextField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'ConfigFile.content'
        db.alter_column(u'firmware_configfile', 'content', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'ConfigUCI.value'
        db.alter_column(u'firmware_configuci', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))
