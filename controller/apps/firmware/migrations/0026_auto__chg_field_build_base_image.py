...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding index on 'Build', fields ['base_image']
        db.create_index(u'firmware_build', ['base_image_id'])


        # Renaming column for 'Build.base_image' to match new field type.
        db.rename_column(u'firmware_build', 'base_image', 'base_image_id')
        # Changing field 'Build.base_image'
        db.alter_column(u'firmware_build', 'base_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['firmware.BaseImage'], null=True))
