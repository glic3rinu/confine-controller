...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'firmware_baseimage', 'name',
                      self.gf('django.db.models.fields.CharField')(default='baseimage', unique=False, max_length=256),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'BaseImage.name'
        db.delete_column(u'firmware_baseimage', 'name')


        # Changing field 'Build.node'
        db.alter_column(u'firmware_build', 'node_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['nodes.Node'], unique=True))
