...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConfigPlugin.short_description'
        db.delete_column(u'firmware_configplugin', 'short_description')

        # Deleting field 'ConfigPlugin.help_text'
        db.delete_column(u'firmware_configplugin', 'help_text')

        # Adding field 'ConfigPlugin.description'
        db.add_column(u'firmware_configplugin', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'ConfigPlugin.label'
        db.alter_column(u'firmware_configplugin', 'label', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128))

    def backwards(self, orm):
        # Adding field 'ConfigPlugin.short_description'
        db.add_column(u'firmware_configplugin', 'short_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ConfigPlugin.help_text'
        db.add_column(u'firmware_configplugin', 'help_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'ConfigPlugin.description'
        db.delete_column(u'firmware_configplugin', 'description')


        # Changing field 'ConfigPlugin.label'
        db.alter_column(u'firmware_configplugin', 'label', self.gf('django.db.models.fields.TextField')(unique=True))
    ...
    models = {
        ...
        u'firmware.build': {
            ...
            'base_image': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
