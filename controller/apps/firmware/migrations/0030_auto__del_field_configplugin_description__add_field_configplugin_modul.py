...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConfigPlugin.module'
        db.add_column(u'firmware_configplugin', 'module',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ConfigPlugin.module'
        db.delete_column(u'firmware_configplugin', 'module')
