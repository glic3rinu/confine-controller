...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'firmware_nodekeys', (
            ('ssh_auth', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('ssh_pass', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('node', self.gf('django.db.models.fields.related.OneToOneField')(related_name='keys', unique=True, primary_key=True, to=orm['nodes.Node'])),
        ))
        db.send_create_signal(u'firmware', ['NodeKeys'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NodeKeys'
        db.delete_table(u'firmware_nodekeys')
