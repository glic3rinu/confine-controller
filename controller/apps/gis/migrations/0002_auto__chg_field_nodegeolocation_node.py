...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NodeGeolocation.node'
        db.alter_column(u'gis_nodegeolocation', 'node_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, null=True, to=orm['nodes.Node']))
    ...
    models = {
        ...
        u'gis.nodegeolocation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'node': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'gis'", 'unique': 'True', 'null': 'True', 'to': u"orm['nodes.Node']"})
        },
        u'nodes.node': {
