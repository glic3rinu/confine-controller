...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.visibility'
        db.delete_column(u'issues_message', 'visibility')

        # Adding field 'Ticket.visibility'
        db.add_column(u'issues_ticket', 'visibility',
                      self.gf('django.db.models.fields.CharField')(default='PUBLIC', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Message.visibility'
        db.add_column(u'issues_message', 'visibility',
                      self.gf('django.db.models.fields.CharField')(default='PUBLIC', max_length=32),
                      keep_default=False)

        # Deleting field 'Ticket.visibility'
        db.delete_column(u'issues_ticket', 'visibility')
