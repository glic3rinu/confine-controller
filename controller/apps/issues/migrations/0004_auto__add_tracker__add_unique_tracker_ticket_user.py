...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'issues.tracker': {
            'Meta': {'unique_together': "(('ticket', 'user'),)", 'object_name': 'Tracker'},
            'autogenerated': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'UNREAD'", 'max_length': '32'}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'trackers'", 'to': u"orm['issues.Ticket']"}),
