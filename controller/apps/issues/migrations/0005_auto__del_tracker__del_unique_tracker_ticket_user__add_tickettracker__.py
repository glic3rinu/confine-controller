...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Tracker', fields ['ticket', 'user']
        db.delete_unique(u'issues_tracker', ['ticket_id', 'user_id'])

        # Deleting model 'Tracker'
        db.delete_table(u'issues_tracker')

        # Adding model 'TicketTracker'
        db.create_table(u'issues_tickettracker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Ticket'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'])),
        ))
        db.send_create_signal(u'issues', ['TicketTracker'])

        # Adding unique constraint on 'TicketTracker', fields ['ticket', 'user']
        db.create_unique(u'issues_tickettracker', ['ticket_id', 'user_id'])

        # Adding field 'Ticket.group'
        db.add_column(u'issues_ticket', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assigned_tickets', null=True, to=orm['users.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'TicketTracker', fields ['ticket', 'user']
        db.delete_unique(u'issues_tickettracker', ['ticket_id', 'user_id'])

        # Adding model 'Tracker'
        db.create_table(u'issues_tracker', (
            ('autogenerated', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='UNREAD', max_length=32)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'])),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trackers', to=orm['issues.Ticket'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'issues', ['Tracker'])

        # Adding unique constraint on 'Tracker', fields ['ticket', 'user']
        db.create_unique(u'issues_tracker', ['ticket_id', 'user_id'])

        # Deleting model 'TicketTracker'
        db.delete_table(u'issues_tickettracker')

        # Deleting field 'Ticket.group'
        db.delete_column(u'issues_ticket', 'group_id')
