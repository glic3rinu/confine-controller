...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queue.notify_admins'
        db.add_column(u'issues_queue', 'notify_admins',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Queue.notify_technicians'
        db.add_column(u'issues_queue', 'notify_technicians',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Queue.notify_researchers'
        db.add_column(u'issues_queue', 'notify_researchers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queue.notify_admins'
        db.delete_column(u'issues_queue', 'notify_admins')

        # Deleting field 'Queue.notify_technicians'
        db.delete_column(u'issues_queue', 'notify_technicians')

        # Deleting field 'Queue.notify_researchers'
        db.delete_column(u'issues_queue', 'notify_researchers')
    ...
    models = {
        ...
        u'issues.ticket': {
            ...
            'queue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tickets'", 'to': u"orm['issues.Queue']"}),
