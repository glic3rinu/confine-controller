...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tinc_tinchost', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pubkey', self.gf('controller.models.fields.RSAPublicKeyField')(unique=True, null=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'tinc', ['TincHost'])

        # Adding unique constraint on 'TincHost', fields ['content_type', 'object_id']
        db.create_unique(u'tinc_tinchost', ['content_type_id', 'object_id'])

        # Adding field 'TincAddress.host'
        db.add_column(u'tinc_tincaddress', 'host',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='addresses', null=True, to=orm['tinc.TincHost']),
                      keep_default=False)


        # Changing field 'TincAddress.server'
        db.alter_column(u'tinc_tincaddress', 'server_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tinc.TincServer']))

    def backwards(self, orm):
        # Removing unique constraint on 'TincHost', fields ['content_type', 'object_id']
        db.delete_unique(u'tinc_tinchost', ['content_type_id', 'object_id'])

        # Deleting model 'TincHost'
        db.delete_table(u'tinc_tinchost')

        # Deleting field 'TincAddress.host'
        db.delete_column(u'tinc_tincaddress', 'host_id')


        # Changing field 'TincAddress.server'
        db.alter_column(u'tinc_tincaddress', 'server_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tinc.TincServer']))
