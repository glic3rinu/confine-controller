...
import controller.apps.nodes.validators
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text=b'The name of the interface used as a local interface (non-empty). See <a href="https://wiki.confine-project.eu/arch:node">node architecture</a>.', max_length=16, validators=[controller.core.validators.validate_net_iface_name_with_vlan])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local_iface', models.CharField(default=b'eth0', help_text=b'Name of the interface used as a local interface. See <a href="wiki.confine-project.eu/arch:node">node architecture</a>.', max_length=16, verbose_name=b'Local interface', validators=[controller.core.validators.validate_net_iface_name_with_vlan])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cert', controller.models.fields.PEMCertificateField(help_text=b"An optional X.509 PEM-encoded certificate for the API endpoint. Providing this may save API clients from checking the API certificate's signature.", null=True, verbose_name=b'Certificate', blank=True)),
                ('type', models.CharField(default=b'node', max_length=16, choices=[(b'node', b'Node')])),
                ('node', models.OneToOneField(related_name='_api', primary_key=True, serialize=False, to='nodes.Node')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node', models.ForeignKey(related_name='properties', to='nodes.Node')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server', models.ForeignKey(related_name='api', to='nodes.Server')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text=b'Per node unique single line of free-form text with no whitespace surrounding it.', max_length=32, validators=[controller.core.validators.validate_prop_name])),
                ('value', models.CharField(max_length=256)),
                ('server', models.ForeignKey(related_name='properties', to='nodes.Server')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='node',
            field=models.ForeignKey(related_name='direct_ifaces', to='nodes.Node'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='directiface',
