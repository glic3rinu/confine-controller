...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'nodes_configuci', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(related_name='config_uci', to=orm['nodes.Node'])),
        ...
        db.send_create_signal(u'nodes', ['ConfigUCI'])

        # Adding unique constraint on 'ConfigUCI', fields ['node', 'option']
        db.create_unique(u'nodes_configuci', ['node_id', 'option'])


    def backwards(self, orm):
        # Removing unique constraint on 'ConfigUCI', fields ['node', 'option']
        db.delete_unique(u'nodes_configuci', ['node_id', 'option'])

        # Deleting model 'ConfigUCI'
        db.delete_table(u'nodes_configuci')


    models = {
        u'nodes.configuci': {
            'Meta': {'unique_together': "(['node', 'option'],)", 'object_name': 'ConfigUCI'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'node': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'config_uci'", 'to': u"orm['nodes.Node']"}),
