...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServerProp'
        db.create_table(u'nodes_serverprop', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(related_name='properties', to=orm['nodes.Server'])),
        ))
        db.send_create_signal(u'nodes', ['ServerProp'])

        # Adding unique constraint on 'ServerProp', fields ['server', 'name']
        db.create_unique(u'nodes_serverprop', ['server_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ServerProp', fields ['server', 'name']
        db.delete_unique(u'nodes_serverprop', ['server_id', 'name'])

        # Deleting model 'ServerProp'
        db.delete_table(u'nodes_serverprop')
