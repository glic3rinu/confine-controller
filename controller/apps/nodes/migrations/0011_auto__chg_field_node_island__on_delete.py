...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Node.island'
        db.alter_column(u'nodes_node', 'island_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Island'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Node.island'
        db.alter_column(u'nodes_node', 'island_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Island'], null=True))
