...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServerApi.island'
        db.alter_column(u'nodes_serverapi', 'island_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Island'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'ServerApi.island'
        db.alter_column(u'nodes_serverapi', 'island_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Island'], null=True))
