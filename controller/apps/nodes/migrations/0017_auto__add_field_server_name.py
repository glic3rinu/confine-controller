...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'nodes_server', 'description', 'name')

        # Adding unique constraint on 'Server', fields ['name']
        db.create_unique(u'nodes_server', ['name'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Server', fields ['description']
        db.delete_unique(u'nodes_server', ['name'])

        # Rename 'description' --> 'name'
        db.rename_column(u'nodes_server', 'name', 'description')
