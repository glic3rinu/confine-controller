...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'Ping', fields ['date']
        db.delete_index(u'pings_ping', ['date'])

        # Adding index on 'Ping', fields ['date', 'content_type', 'object_id']
        db.create_index(u'pings_ping', ['date', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing index on 'Ping', fields ['date', 'content_type', 'object_id']
        db.delete_index(u'pings_ping', ['date', 'content_type_id', 'object_id'])

        # Adding index on 'Ping', fields ['date']
        db.create_index(u'pings_ping', ['date'])
