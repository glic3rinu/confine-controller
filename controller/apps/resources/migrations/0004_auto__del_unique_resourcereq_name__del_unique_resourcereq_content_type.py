...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ResourceReq', fields ['name']
        db.delete_unique(u'resources_resourcereq', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'ResourceReq', fields ['name']
        db.create_unique(u'resources_resourcereq', ['name'])
