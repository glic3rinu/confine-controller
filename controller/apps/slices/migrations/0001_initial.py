...
import controller.apps.slices.helpers
import controller.core.validators
import controller.apps.slices.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_on', models.DateField(default=controller.apps.slices.models.get_expires_on, help_text=b'Expiration date of this slice. Automatically deleted once expires.', null=True, blank=True)),
                ...
                ('group', models.ForeignKey(related_name='slices', to='users.Group')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slice', models.ForeignKey(related_name='properties', to='slices.Slice')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.FileField(help_text=b'File containing data for this sliver.', upload_to=controller.apps.slices.helpers.UploadToGenerator(b'data', b'exp_data', b'sliver-%(pk)d-%(original)s'), verbose_name=b'sliver data', blank=True)),
                ('data_uri', controller.models.fields.NullableCharField(help_text=b'If present, the URI of a file containing data for this sliver, instead of the one specified by the slice. Its format and contents depend on the type of the template to be used.', max_length=256, null=True, verbose_name=b'sliver data URI', blank=True)),
                ('data_sha256', controller.models.fields.NullableCharField(validators=[controller.core.validators.validate_sha256], max_length=64, blank=True, help_text=b'The SHA256 hash of the sliver data file, used to check its integrity. Compulsory when a file has been specified.', null=True, verbose_name=b'sliver data SHA256')),
                ...
                ('node', models.ForeignKey(related_name='slivers', to='nodes.Node')),
                ('slice', models.ForeignKey(related_name='slivers', to='slices.Slice')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.FileField(help_text=b'File containing experiment data for slivers (if they do not explicitly indicate one)', upload_to=controller.apps.slices.helpers.UploadToGenerator(b'data', b'exp_data', b'slice-%(pk)d-%(original)s'), verbose_name=b'sliver data', blank=True)),
                ('data_uri', controller.models.fields.NullableCharField(help_text=b'The URI of a file containing sliver data for slivers (if they do not explicitly indicate one). Its format and contents depend on the type of the template to be used.', max_length=256, null=True, verbose_name=b'sliver data URI', blank=True)),
                ('data_sha256', controller.models.fields.NullableCharField(validators=[controller.core.validators.validate_sha256], max_length=64, blank=True, help_text=b'The SHA256 hash of the data file, used to check its integrity. Compulsory when a file has been specified.', null=True, verbose_name=b'sliver data SHA256')),
                ...
                ('slice', models.OneToOneField(related_name='sliver_defaults', to='slices.Slice')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('nr', models.PositiveIntegerField(help_text=b'The unique 8-bit, positive integer number of this interface in this sliver. Interface #0 is always the private interface, #1 is by convention the main management interface and #2 is by convention the main public interface.', verbose_name=b'number')),
                ...
                ('sliver', models.ForeignKey(related_name='interfaces', to='slices.Sliver')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text=b'Per slice unique single line of free-form text with no whitespace surrounding it', max_length=64, validators=[controller.core.validators.validate_prop_name])),
                ('value', models.CharField(max_length=256)),
                ('sliver', models.ForeignKey(related_name='properties', to='slices.Sliver')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node_archs', controller.models.fields.MultiSelectField(default=b'', help_text=b'The node architectures accepted by this template (as reported by uname -m, non-empty). Slivers using this template should run on nodes whose architecture is listed here.', max_length=256, choices=[(b'x86_64', b'x86_64'), (b'i586', b'i586'), (b'i686', b'i686')])),
                ('is_active', models.BooleanField(default=True)),
                ('image', models.FileField(help_text=b"Template's image file.", upload_to=controller.apps.slices.helpers.UploadToGenerator(b'image', b'templates', b''), validators=[controller.core.validators.FileExtValidator((b'.tar.gz', b'.tgz'))])),
                ('image_uri', models.CharField(help_text=b"The URI of this template's image file. This member cannot be changed if the template is in use. This member may be set directly or through the do-upload-image controller API function.", max_length=256, verbose_name=b'image URI', blank=True)),
                ('image_sha256', models.CharField(blank=True, help_text=b'The SHA256 hash of the previous file, used to check its integrity. This member cannot be changed if the template is in use. This member may be set directly or through the do-upload-image controller API function.', max_length=64, verbose_name=b'image SHA256', validators=[controller.core.validators.validate_sha256])),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AlterUniqueTogether(
            name='sliveriface',
            unique_together=set([('sliver', 'name'), ('sliver', 'nr')]),
        ),
        migrations.AddField(
