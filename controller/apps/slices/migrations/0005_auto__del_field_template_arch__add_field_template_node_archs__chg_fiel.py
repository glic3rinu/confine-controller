...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Template.arch'
        db.delete_column(u'slices_template', 'arch')
    ...
    def backwards(self, orm):
        # Adding field 'Template.arch'
        db.add_column(u'slices_template', 'arch',
                      self.gf('django.db.models.fields.CharField')(default='amd64', max_length=32),
                      keep_default=False)

        # Deleting field 'Template.node_archs'
        db.delete_column(u'slices_template', 'node_archs')


        # Changing field 'Sliver.exp_data'
        db.alter_column(u'slices_sliver', 'exp_data', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Slice.exp_data'
        db.alter_column(u'slices_slice', 'exp_data', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        u'slices.privateiface': {
            'Meta': {'unique_together': "(['sliver', 'name'],)", 'object_name': 'PrivateIface'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
        ...
        u'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
