...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sliver.exp_data_uri'
        db.add_column(u'slices_sliver', 'exp_data_uri',
    ...
    def backwards(self, orm):
        # Deleting field 'Sliver.exp_data_uri'
        db.delete_column(u'slices_sliver', 'exp_data_uri')
