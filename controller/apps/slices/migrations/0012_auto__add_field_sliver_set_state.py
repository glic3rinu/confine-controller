...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sliver.set_state'
        db.add_column(u'slices_sliver', 'set_state',
                      self.gf('django.db.models.fields.CharField')(default='register', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sliver.set_state'
        db.delete_column(u'slices_sliver', 'set_state')
    ...
    models = {
        ...
        u'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
