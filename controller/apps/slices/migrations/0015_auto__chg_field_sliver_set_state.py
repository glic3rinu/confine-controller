...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sliver.set_state'
        db.alter_column(u'slices_sliver', 'set_state', self.gf('controller.models.fields.NullableCharField')(max_length=16, null=True))

    def backwards(self, orm):

        # Changing field 'Sliver.set_state'
        db.alter_column(u'slices_sliver', 'set_state', self.gf('django.db.models.fields.CharField')(default='', max_length=16))
    ...
    models = {
        ...
        u'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
