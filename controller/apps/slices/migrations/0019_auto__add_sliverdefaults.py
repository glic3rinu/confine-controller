...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'slices_sliverdefaults', (
            ...
            ('exp_data_uri', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('exp_data_sha256', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
