...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sliver.data_uri'
        db.alter_column(u'slices_sliver', 'data_uri', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Sliver.data_sha256'
        db.alter_column(u'slices_sliver', 'data_sha256', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'SliverDefaults.data_uri'
        db.alter_column(u'slices_sliverdefaults', 'data_uri', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'SliverDefaults.data_sha256'
        db.alter_column(u'slices_sliverdefaults', 'data_sha256', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Sliver.data_uri'
        db.alter_column(u'slices_sliver', 'data_uri', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'Sliver.data_sha256'
        db.alter_column(u'slices_sliver', 'data_sha256', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'SliverDefaults.data_uri'
        db.alter_column(u'slices_sliverdefaults', 'data_uri', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'SliverDefaults.data_sha256'
        db.alter_column(u'slices_sliverdefaults', 'data_sha256', self.gf('django.db.models.fields.CharField')(default='', max_length=64))
    ...
    models = {
        ...
        u'slices.slice': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 11, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'slices.sliver': {
            ...
            'data_sha256': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'data_uri': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance_sn': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'blank': 'True'}),
