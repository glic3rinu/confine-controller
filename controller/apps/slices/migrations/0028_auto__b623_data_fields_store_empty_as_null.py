...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'slices_sliver', 'data_uri', self.gf('controller.models.fields.NullableCharField')(max_length=256, null=True))

        # Changing field 'Sliver.data_sha256'
        db.alter_column(u'slices_sliver', 'data_sha256', self.gf('controller.models.fields.NullableCharField')(max_length=64, null=True))

        # Changing field 'SliverDefaults.data_uri'
        db.alter_column(u'slices_sliverdefaults', 'data_uri', self.gf('controller.models.fields.NullableCharField')(max_length=256, null=True))

        # Changing field 'SliverDefaults.data_sha256'
        db.alter_column(u'slices_sliverdefaults', 'data_sha256', self.gf('controller.models.fields.NullableCharField')(max_length=64, null=True))
