...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'slices_slice', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128))

    def backwards(self, orm):

        # Changing field 'Slice.name'
        db.alter_column(u'slices_slice', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True))
    ...
    models = {
        ...
        u'slices.slice': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 17, 0, 0)', 'null': 'True', 'blank': 'True'}),
