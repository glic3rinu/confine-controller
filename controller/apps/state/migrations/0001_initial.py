...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'state_nodestate', (
            ...
            ('node', self.gf('django.db.models.fields.related.OneToOneField')(related_name='state', unique=True, to=orm['nodes.Node'])),
            ('last_succes_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('last_retry_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
    ...
    models = {
        ...
        u'state.nodestate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_retry_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'last_succes_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
