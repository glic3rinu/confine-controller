...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'state_sliverstate', (
            ...
            ('metadata', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('last_seen_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('last_try_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('sliver', self.gf('django.db.models.fields.related.OneToOneField')(related_name='state', unique=True, to=orm['slices.Sliver'])),
        ))
        db.send_create_signal(u'state', ['SliverState'])

        # Deleting field 'NodeState.last_retry_on'
        db.delete_column(u'state_nodestate', 'last_retry_on')

        # Deleting field 'NodeState.last_success_on'
        db.delete_column(u'state_nodestate', 'last_success_on')

        # Adding field 'NodeState.data'
        db.add_column(u'state_nodestate', 'data',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'NodeState.last_seen_on'
        db.add_column(u'state_nodestate', 'last_seen_on',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'state_nodestate', 'last_success_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'NodeState.data'
        db.delete_column(u'state_nodestate', 'data')

        # Deleting field 'NodeState.last_seen_on'
        db.delete_column(u'state_nodestate', 'last_seen_on')

        # Deleting field 'NodeState.last_try_on'
        db.delete_column(u'state_nodestate', 'last_try_on')
    ...
    models = {
        ...
        u'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 4, 17, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'state.nodestate': {
            ...
            'last_try_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'metadata': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'node': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'state'", 'unique': 'True', 'to': u"orm['nodes.Node']"})
        },
        u'state.sliverstate': {
            ...
            'last_try_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'metadata': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'sliver': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'state'", 'unique': 'True', 'to': u"orm['slices.Sliver']"})
        },
        u'tinc.island': {
