...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NodeState.metadata'
        db.alter_column(u'state_nodestate', 'metadata', self.gf('django.db.models.fields.TextField')())

        # Changing field 'SliverState.metadata'
        db.alter_column(u'state_sliverstate', 'metadata', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'NodeState.metadata'
        db.alter_column(u'state_nodestate', 'metadata', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'SliverState.metadata'
        db.alter_column(u'state_sliverstate', 'metadata', self.gf('django.db.models.fields.CharField')(max_length=256))
