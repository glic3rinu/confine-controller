...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeState.last_contact'
        db.add_column(u'state_nodestate', 'last_contact',
    ...
    def backwards(self, orm):
        # Deleting field 'NodeState.last_contact'
        db.delete_column(u'state_nodestate', 'last_contact')


        # Changing field 'NodeState.last_try_on'
        db.alter_column(u'state_nodestate', 'last_try_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=None))

        # Changing field 'SliverState.last_try_on'
        db.alter_column(u'state_sliverstate', 'last_try_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=None))
    ...
    models = {
        ...
        u'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'state.nodestate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_contact': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'last_seen_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'last_try_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
