...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeState.last_contact_on'
        db.add_column(u'state_nodestate', 'last_contact_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NodeState.last_contact_on'
        db.delete_column(u'state_nodestate', 'last_contact_on')
