...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NodeState.version'
        db.delete_column(u'state_nodestate', 'version')

        # Adding field 'NodeState.soft_version'
        db.add_column(u'state_nodestate', 'soft_version',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NodeState.version'
        db.add_column(u'state_nodestate', 'version',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Deleting field 'NodeState.soft_version'
        db.delete_column(u'state_nodestate', 'soft_version')
    ...
    models = {
        ...
        u'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 10, 0, 0)', 'null': 'True', 'blank': 'True'}),
