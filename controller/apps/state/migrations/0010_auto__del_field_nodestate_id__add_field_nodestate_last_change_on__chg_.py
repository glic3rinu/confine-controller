...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NodeState.id'
        db.delete_column(u'state_nodestate', u'id')

        # Adding field 'NodeState.last_change_on'
        db.add_column(u'state_nodestate', 'last_change_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'NodeState.node'
        db.alter_column(u'state_nodestate', 'node_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['nodes.Node']))

        # Changing field 'NodeState.last_try_on'
        db.alter_column(u'state_nodestate', 'last_try_on', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'SliverState.id'
        db.delete_column(u'state_sliverstate', u'id')

        # Adding field 'SliverState.last_change_on'
        db.add_column(u'state_sliverstate', 'last_change_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'SliverState.last_try_on'
        db.alter_column(u'state_sliverstate', 'last_try_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'SliverState.sliver'
        db.alter_column(u'state_sliverstate', 'sliver_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['slices.Sliver']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'NodeState.id'
        raise RuntimeError("Cannot reverse this migration. 'NodeState.id' and its values cannot be restored.")
        # Deleting field 'NodeState.last_change_on'
        db.delete_column(u'state_nodestate', 'last_change_on')


        # Changing field 'NodeState.node'
        db.alter_column(u'state_nodestate', 'node_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['nodes.Node']))

        # Changing field 'NodeState.last_try_on'
        db.alter_column(u'state_nodestate', 'last_try_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # User chose to not deal with backwards NULL issues for 'SliverState.id'
        raise RuntimeError("Cannot reverse this migration. 'SliverState.id' and its values cannot be restored.")
        # Deleting field 'SliverState.last_change_on'
        db.delete_column(u'state_sliverstate', 'last_change_on')


        # Changing field 'SliverState.last_try_on'
        db.alter_column(u'state_sliverstate', 'last_try_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'SliverState.sliver'
        db.alter_column(u'state_sliverstate', 'sliver_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['slices.Sliver']))
    ...
    models = {
        ...
        u'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'state.nodestate': {
            'Meta': {'object_name': 'NodeState'},
            'data': ('django.db.models.fields.TextField', [], {}),
            'last_change_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'node': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'state'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['nodes.Node']"}),
            'soft_version': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'})
        },
        u'state.sliverstate': {
            'Meta': {'object_name': 'SliverState'},
            'data': ('django.db.models.fields.TextField', [], {}),
            'last_change_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'last_seen_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'last_try_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'metadata': ('django.db.models.fields.TextField', [], {}),
            'sliver': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'state'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['slices.Sliver']"})
        },
        u'tinc.island': {
