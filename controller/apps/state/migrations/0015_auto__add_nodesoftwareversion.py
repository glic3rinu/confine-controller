...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NodeSoftwareVersion'
        db.create_table(u'state_nodesoftwareversion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('node', self.gf('django.db.models.fields.related.OneToOneField')(related_name='soft_version', unique=True, to=orm['nodes.Node'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal(u'state', ['NodeSoftwareVersion'])


    def backwards(self, orm):
        # Deleting model 'NodeSoftwareVersion'
        db.delete_table(u'state_nodesoftwareversion')
