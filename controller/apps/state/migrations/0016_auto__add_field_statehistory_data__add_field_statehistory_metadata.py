...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StateHistory.data'
        db.add_column(u'state_statehistory', 'data',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StateHistory.metadata'
        db.add_column(u'state_statehistory', 'metadata',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StateHistory.data'
        db.delete_column(u'state_statehistory', 'data')

        # Deleting field 'StateHistory.metadata'
        db.delete_column(u'state_statehistory', 'metadata')
