    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(related_name=b'tinc_hosts', to=settings.AUTH_USER_MODEL, help_text=b'The user who administrates this host (its creator by default)')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='host',
            field=models.ForeignKey(related_name=b'addresses', to='tinc.TincHost'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='tincaddress',
            name='island',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to='nodes.Island', help_text=b'<a href="http://wiki.confine-project.eu/arch:rest-api#island_at_server">Island</a> this tinc address is reachable from.', null=True),
            preserve_default=True,
        ),
    ]
