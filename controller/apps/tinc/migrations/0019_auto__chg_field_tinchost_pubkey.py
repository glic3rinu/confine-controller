...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TincHost.pubkey'
        db.alter_column(u'tinc_tinchost', 'pubkey', self.gf('controller.models.fields.RSAPublicKeyField')(unique=True))

    def backwards(self, orm):

        # Changing field 'TincHost.pubkey'
        db.alter_column(u'tinc_tinchost', 'pubkey', self.gf('controller.models.fields.RSAPublicKeyField')(unique=True, null=True, blank=True))
