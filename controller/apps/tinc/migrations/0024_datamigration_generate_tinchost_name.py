...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Generate TincHost name to store into DB."
        # Note: Don't use "from appname.models import ModelName".
        # Use orm.ModelName to refer to models in this application,
        # and orm['appname.ModelName'] for models in other applications.
        for tinchost in orm.TincHost.objects.all():
            ctype = ContentType.objects.get(pk=tinchost.content_type_id)
            tinchost.name = u'%s_%s' % (ctype.model, tinchost.object_id)
            tinchost.save()
    ...
    models = {
        ...
        u'tinc.tinchost': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32', 'unique': 'True', 'null': 'True'}),
