...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TincHost.name'
        db.alter_column(u'tinc_tinchost', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32))

    def backwards(self, orm):

        # Changing field 'TincHost.name'
        db.alter_column(u'tinc_tinchost', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, null=True))
