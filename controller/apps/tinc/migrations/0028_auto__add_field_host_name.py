...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'tinc_host', 'description', 'name')

        # Adding field 'Host.description'
        db.add_column(u'tinc_host', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'tinc_host', 'description')

        # Rename 'description' --> 'name'
        db.rename_column(u'tinc_host', 'name', 'description')
