...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tinc_host', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256))
        # Adding unique constraint on 'Host', fields ['name']
        db.create_unique(u'tinc_host', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Host', fields ['name']
        db.delete_unique(u'tinc_host', ['name'])


        # Changing field 'Host.name'
        db.alter_column(u'tinc_host', 'name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
