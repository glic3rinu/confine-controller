...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'User.username' to 'User.name'
        #db.rename_column(u'users_user', 'username', 'name')
    ...
    def backwards(self, orm):
        ...
        # Renaming field 'User.name' to 'User.username'
        #db.rename_column(u'users_user', 'name', 'username')
