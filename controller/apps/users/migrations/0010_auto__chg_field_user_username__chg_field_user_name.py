...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_user', 'username', self.gf('controller.models.fields.NullableCharField')(max_length=30, unique=True, null=True))

        # Changing field 'User.name'
        db.alter_column(u'users_user', 'name', self.gf('controller.models.fields.TrimmedCharField')(unique=True, max_length=60))

    def backwards(self, orm):

        # Changing field 'User.name'
        db.alter_column(u'users_user', 'name', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))
