...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Queue'
        db.create_table('issues_queue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('default', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('issues', ['Queue'])
        ...
        db.send_create_signal('issues', ['Ticket'])

        # Adding model 'Message'
        db.create_table('issues_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('issues', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Queue'
        db.delete_table('issues_queue')

        # Deleting model 'Ticket'
        db.delete_table('issues_ticket')

        # Deleting model 'Message'
        db.delete_table('issues_message')
    ...
    models = {
        ...
        'issues.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issues.Ticket']"}),
