...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TincClient.object_id'
        db.alter_column(u'tinc_tincclient', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'TincServer.object_id'
        db.alter_column(u'tinc_tincserver', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'TincClient.object_id'
        db.alter_column(u'tinc_tincclient', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=36))

        # Changing field 'TincServer.object_id'
        db.alter_column(u'tinc_tincserver', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=36))
