...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TincClient.island'
        db.alter_column(u'tinc_tincclient', 'island_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tinc.Island'], null=True))

        # Changing field 'TincAddress.island'
        db.alter_column(u'tinc_tincaddress', 'island_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tinc.Island'], null=True))
        # Adding field 'TincServer.is_active'
        db.add_column(u'tinc_tincserver', 'is_active',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TincClient.island'
        db.alter_column(u'tinc_tincclient', 'island_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tinc.Island']))

        # Changing field 'TincAddress.island'
        db.alter_column(u'tinc_tincaddress', 'island_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tinc.Island']))
        # Deleting field 'TincServer.is_active'
        db.delete_column(u'tinc_tincserver', 'is_active')
