...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Node.action'
        db.delete_column('nodes_node', 'action')

        # Adding field 'Node.set_state'
        db.add_column('nodes_node', 'set_state',
        ...
        # Adding field 'Node.rd_cert'
        db.add_column('nodes_node', 'rd_cert',
                      self.gf('django.db.models.fields.TextField')(default='RD CERT'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'Node.action'
        db.add_column('nodes_node', 'action',
                      self.gf('django.db.models.fields.CharField')(default='ONLINE', max_length=32),
                      keep_default=False)

        # Deleting field 'Node.set_state'
        db.delete_column('nodes_node', 'set_state')
        ...
        # Deleting field 'Node.rd_cert'
        db.delete_column('nodes_node', 'rd_cert')
