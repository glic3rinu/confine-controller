...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Node.admin'
        db.alter_column(u'nodes_node', 'admin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

    def backwards(self, orm):

        # Changing field 'Node.admin'
        db.alter_column(u'nodes_node', 'admin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
