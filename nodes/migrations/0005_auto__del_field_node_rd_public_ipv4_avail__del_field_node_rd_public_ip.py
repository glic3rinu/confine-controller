...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Node.rd_public_ipv4_avail'
        db.delete_column('nodes_node', 'rd_public_ipv4_avail')

        # Deleting field 'Node.rd_public_ipv4_total'
        db.delete_column('nodes_node', 'rd_public_ipv4_total')

        # Adding field 'Node.sliver_public_ipv4_total'
        db.add_column('nodes_node', 'sliver_public_ipv4_total',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Node.sliver_public_ipv4_avail'
        db.add_column('nodes_node', 'sliver_public_ipv4_avail',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Node.rd_public_ipv4_avail'
        db.add_column('nodes_node', 'rd_public_ipv4_avail',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.rd_public_ipv4_total'
        db.add_column('nodes_node', 'rd_public_ipv4_total',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Node.sliver_public_ipv4_total'
        db.delete_column('nodes_node', 'sliver_public_ipv4_total')

        # Deleting field 'Node.sliver_public_ipv4_avail'
        db.delete_column('nodes_node', 'sliver_public_ipv4_avail')
