...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('nodes_node', 'cndb_uri',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.cndb_cached'
        db.add_column('nodes_node', 'cndb_cached',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.rd_local_iface'
        db.add_column('nodes_node', 'rd_local_iface',
                      self.gf('django.db.models.fields.CharField')(default='eth0', max_length=200),
                      keep_default=False)

        # Adding field 'Node.rd_cn_url'
        db.add_column('nodes_node', 'rd_cn_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.rd_cndb_uri'
        db.add_column('nodes_node', 'rd_cndb_uri',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Node.rd_cndb_cached'
        db.add_column('nodes_node', 'rd_cndb_cached',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Node.cn_url'
        db.alter_column('nodes_node', 'cn_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    def backwards(self, orm):
        # Deleting field 'Node.cndb_uri'
        db.delete_column('nodes_node', 'cndb_uri')

        # Deleting field 'Node.cndb_cached'
        db.delete_column('nodes_node', 'cndb_cached')

        # Deleting field 'Node.rd_local_iface'
        db.delete_column('nodes_node', 'rd_local_iface')

        # Deleting field 'Node.rd_cn_url'
        db.delete_column('nodes_node', 'rd_cn_url')

        # Deleting field 'Node.rd_cndb_uri'
        db.delete_column('nodes_node', 'rd_cndb_uri')

        # Deleting field 'Node.rd_cndb_cached'
        db.delete_column('nodes_node', 'rd_cndb_cached')


        # Changing field 'Node.cn_url'
        db.alter_column('nodes_node', 'cn_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
    models = {
        'auth.group': {
        ...
        'nodes.node': {
            ...
            'admin': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'cn_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'cndb_cached': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'cndb_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'rd_cn_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'rd_cndb_cached': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'rd_cndb_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'rd_local_iface': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
