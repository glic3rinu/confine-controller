...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interface.channel'
        db.add_column('nodes_interface', 'channel',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Interface.essid'
        db.add_column('nodes_interface', 'essid',
                      self.gf('django.db.models.fields.CharField')(max_length='150', null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Interface.channel'
        db.delete_column('nodes_interface', 'channel')

        # Deleting field 'Interface.essid'
        db.delete_column('nodes_interface', 'essid')
