...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('slices_slice', (
            ...
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('expires_on', self.gf('django.db.models.fields.DateField')(blank=True)),
        ...
        db.create_table('slices_isolatediface', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='eth', max_length=16)),
            ('sliver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['slices.Sliver'])),
            ('parent_name', self.gf('django.db.models.fields.CharField')(default='eth', max_length=16)),
        ))
