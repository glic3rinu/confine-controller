...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sliver.node'
        db.add_column('slices_sliver', 'node',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['nodes.Node']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sliver.node'
        db.delete_column('slices_sliver', 'node_id')
