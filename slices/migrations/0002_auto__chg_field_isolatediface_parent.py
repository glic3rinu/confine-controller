...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IsolatedIface.parent'
        db.alter_column('slices_isolatediface', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['nodes.DirectIface']))

    def backwards(self, orm):

        # Changing field 'IsolatedIface.parent'
        db.alter_column('slices_isolatediface', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.DirectIface'], null=True))
    ...
    models = {
        ...
        'slices.isolatediface': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['nodes.DirectIface']"}),
        ...
        'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
