...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Slice.pubkey'
        db.alter_column('slices_slice', 'pubkey', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Slice.vlan_nr'
        db.alter_column('slices_slice', 'vlan_nr', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Slice.pubkey'
        db.alter_column('slices_slice', 'pubkey', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Slice.vlan_nr'
        db.alter_column('slices_slice', 'vlan_nr', self.gf('django.db.models.fields.IntegerField')(default=None))
