...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Slice.action'
        db.delete_column('slices_slice', 'action')

        # Adding field 'Slice.set_state'
        db.add_column('slices_slice', 'set_state',
                      self.gf('django.db.models.fields.CharField')(default='INSERTED', max_length=16),
                      keep_default=False)

        # Adding field 'Slice.uuid'
        db.add_column('slices_slice', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='UUID', unique=True, max_length=150),
                      keep_default=False)

        # Adding field 'Slice.pubkey'
        db.add_column('slices_slice', 'pubkey',
                      self.gf('django.db.models.fields.TextField')(default='PUBKEY'),
                      keep_default=False)

        # Adding field 'Slice.expires'
        db.add_column('slices_slice', 'expires',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 7, 25, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'Slice.action'
        db.add_column('slices_slice', 'action',
                      self.gf('django.db.models.fields.CharField')(default='INSERTED', max_length=16),
                      keep_default=False)

        # Deleting field 'Slice.set_state'
        db.delete_column('slices_slice', 'set_state')

        # Deleting field 'Slice.uuid'
        db.delete_column('slices_slice', 'uuid')

        # Deleting field 'Slice.pubkey'
        db.delete_column('slices_slice', 'pubkey')

        # Deleting field 'Slice.expires'
        db.delete_column('slices_slice', 'expires')
    ...
    models = {
        ...
        'nodes.node': {
            ...
            'rd_boot_serial': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'slices.slice': {
            ...
            'new_sliver_serial': ('django.db.models.fields.IntegerField', [], {}),
            'pubkey': ('django.db.models.fields.TextField', [], {}),
