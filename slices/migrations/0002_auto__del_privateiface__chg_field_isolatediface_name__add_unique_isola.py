...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IsolatedIface.name'
        db.alter_column(u'slices_isolatediface', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Adding unique constraint on 'IsolatedIface', fields ['name', 'sliver']
        db.create_unique(u'slices_isolatediface', ['name', 'sliver_id'])


        # Changing field 'Pub6Iface.name'
        db.alter_column(u'slices_pub6iface', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'MgmtIface.name'
        db.alter_column(u'slices_mgmtiface', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Pub4Iface.name'
        db.alter_column(u'slices_pub4iface', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):
        # Removing unique constraint on 'IsolatedIface', fields ['name', 'sliver']
        db.delete_unique(u'slices_isolatediface', ['name', 'sliver_id'])
        ...
        # Changing field 'IsolatedIface.name'
        db.alter_column(u'slices_isolatediface', 'name', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Pub6Iface.name'
        db.alter_column(u'slices_pub6iface', 'name', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'MgmtIface.name'
        db.alter_column(u'slices_mgmtiface', 'name', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Pub4Iface.name'
        db.alter_column(u'slices_pub4iface', 'name', self.gf('django.db.models.fields.CharField')(max_length=16))
    ...
    models = {
        ...
        u'slices.isolatediface': {
            'Meta': {'unique_together': "(['sliver', 'name'],)", 'object_name': 'IsolatedIface'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
