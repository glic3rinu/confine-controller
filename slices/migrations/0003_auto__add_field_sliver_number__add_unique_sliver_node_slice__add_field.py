...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sliver.number'
        db.add_column('slices_sliver', 'number',
        ...
        # Adding field 'Slice.write_size'
        db.add_column('slices_slice', 'write_size',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Slice.template'
        db.alter_column('slices_slice', 'template', self.gf('django.db.models.fields.FilePathField')(path='/home/controller/controller/media/templates', max_length=100, recursive=True))
        # Deleting field 'NetworkRequest.max_throughput'
        db.delete_column('slices_networkrequest', 'max_throughput')

        # Deleting field 'NetworkRequest.max_rate'
        db.delete_column('slices_networkrequest', 'max_rate')

        # Deleting field 'NetworkRequest.min_rate'
        db.delete_column('slices_networkrequest', 'min_rate')

        # Adding field 'NetworkRequest.number'
        db.add_column('slices_networkrequest', 'number',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Sliver.number'
        db.delete_column('slices_sliver', 'number')

        # Deleting field 'Slice.write_size'
        db.delete_column('slices_slice', 'write_size')


        # Changing field 'Slice.template'
        db.alter_column('slices_slice', 'template', self.gf('django.db.models.fields.files.FileField')(max_length=100))
        # Adding field 'NetworkRequest.max_throughput'
        db.add_column('slices_networkrequest', 'max_throughput',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'NetworkRequest.max_rate'
        db.add_column('slices_networkrequest', 'max_rate',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'NetworkRequest.min_rate'
        db.add_column('slices_networkrequest', 'min_rate',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'NetworkRequest.number'
        db.delete_column('slices_networkrequest', 'number')
