...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'IsolatedIface', fields ['parent']
        db.create_unique('slices_isolatediface', ['parent_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'IsolatedIface', fields ['parent']
        db.delete_unique('slices_isolatediface', ['parent_id'])
