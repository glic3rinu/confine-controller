...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sliver.instance_sn'
        db.alter_column('slices_sliver', 'instance_sn', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Slice.instance_sn'
        db.alter_column('slices_slice', 'instance_sn', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Sliver.instance_sn'
        db.alter_column('slices_sliver', 'instance_sn', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Slice.instance_sn'
        db.alter_column('slices_slice', 'instance_sn', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'slices.slice': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance_sn': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
