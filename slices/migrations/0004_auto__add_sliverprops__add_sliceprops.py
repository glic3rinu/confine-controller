...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SliverProps'
        db.create_table('slices_sliverprops', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sliver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['slices.Sliver'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('slices', ['SliverProps'])

        # Adding model 'SliceProps'
        db.create_table('slices_sliceprops', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('c_slice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['slices.Slice'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('slices', ['SliceProps'])

    def backwards(self, orm):
        # Deleting model 'SliverProps'
        db.delete_table('slices_sliverprops')

        # Deleting model 'SliceProps'
        db.delete_table('slices_sliceprops')
