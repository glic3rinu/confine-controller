...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sliver.exp_data'
        db.add_column('slices_sliver', 'exp_data',
                      self.gf('django.db.models.fields.files.FileField')(default='firmwares/not_found', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Sliver.template'
        db.add_column('slices_sliver', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['slices.Template'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sliver.exp_data'
        db.delete_column('slices_sliver', 'exp_data')

        # Deleting field 'Sliver.template'
        db.delete_column('slices_sliver', 'template_id')
    ...
    models = {
        ...
        'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 8, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
