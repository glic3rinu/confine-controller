...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SliceProp', fields ['name']
        db.create_unique('slices_sliceprop', ['name'])

        # Adding unique constraint on 'SliverProp', fields ['name']
        db.create_unique('slices_sliverprop', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'SliverProp', fields ['name']
        db.delete_unique('slices_sliverprop', ['name'])

        # Removing unique constraint on 'SliceProp', fields ['name']
        db.delete_unique('slices_sliceprop', ['name'])
    ...
    models = {
        ...
        'slices.isolatediface': {
            'Meta': {'unique_together': "(['sliver', 'parent_name'],)", 'object_name': 'IsolatedIface'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'eth'", 'max_length': '16'}),
            'parent_name': ('django.db.models.fields.CharField', [], {'default': "'eth0'", 'max_length': '16'}),
