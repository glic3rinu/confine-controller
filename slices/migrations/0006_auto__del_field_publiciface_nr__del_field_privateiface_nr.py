...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PublicIface.nr'
        db.delete_column('slices_publiciface', 'nr')

        # Deleting field 'PrivateIface.nr'
        db.delete_column('slices_privateiface', 'nr')

    def backwards(self, orm):
        # Adding field 'PublicIface.nr'
        db.add_column('slices_publiciface', 'nr',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'PrivateIface.nr'
        db.add_column('slices_privateiface', 'nr',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)
