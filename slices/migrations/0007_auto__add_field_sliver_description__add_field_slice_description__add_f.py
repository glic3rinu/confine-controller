...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sliver.description'
        db.add_column('slices_sliver', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Slice.description'
        db.add_column('slices_slice', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SliverTemplate.description'
        db.add_column('slices_slivertemplate', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Sliver.description'
        db.delete_column('slices_sliver', 'description')

        # Deleting field 'Slice.description'
        db.delete_column('slices_slice', 'description')

        # Deleting field 'SliverTemplate.description'
        db.delete_column('slices_slivertemplate', 'description')
    ...
    models = {
        ...
        'nodes.node': {
            ...
            'rd_local_iface': ('django.db.models.fields.CharField', [], {'default': "'eth0'", 'max_length': '200'}),
