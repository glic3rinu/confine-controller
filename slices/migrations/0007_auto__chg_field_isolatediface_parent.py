...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('slices_isolatediface', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.RdDirectIface'], null=True))

    def backwards(self, orm):

        # Changing field 'IsolatedIface.parent'
        db.alter_column('slices_isolatediface', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Node'], null=True))
