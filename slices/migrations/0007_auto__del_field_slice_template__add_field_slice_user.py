...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('slices_slice', 'template',
                      self.gf('django.db.models.fields.FilePathField')(path='/home/isaac/workspace/Pangea/confine/slices/../media/templates', max_length=100, null=True, recursive=True, blank=True),
                      keep_default=False)
