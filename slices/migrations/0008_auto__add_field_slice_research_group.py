...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slice.research_group'
        db.add_column(u'slices_slice', 'research_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.ResearchGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slice.research_group'
        db.delete_column(u'slices_slice', 'research_group_id')
    ...
    models = {
        ...
        u'slices.slice': {
            ...
            'expires_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 19, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
