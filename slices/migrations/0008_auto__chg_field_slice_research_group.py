...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Slice.research_group'
        db.alter_column('slices_slice', 'research_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_management.ResearchGroup'], null=True))
    def backwards(self, orm):

        # Changing field 'Slice.research_group'
        db.alter_column('slices_slice', 'research_group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['user_management.ResearchGroup']))
    models = {
        'auth.group': {
