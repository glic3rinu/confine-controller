...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Slice', fields ['slug']
        db.create_unique('slices_slice', ['slug'])

    def backwards(self, orm):
        # Removing unique constraint on 'Slice', fields ['slug']
        db.delete_unique('slices_slice', ['slug'])
