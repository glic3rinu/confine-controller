...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ticket_system_message', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='ticket_messages', to=orm['auth.User']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Message.author'
        db.delete_column('ticket_system_message', 'author_id')
