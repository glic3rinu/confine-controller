...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('ticket_system_queue', ['name'])


        # Changing field 'Ticket.cc_mails'
        db.alter_column('ticket_system_ticket', 'cc_mails', self.gf('django.db.models.fields.TextField')(null=True))
    def backwards(self, orm):
        # Removing unique constraint on 'Queue', fields ['name']
        db.delete_unique('ticket_system_queue', ['name'])


        # Changing field 'Ticket.cc_mails'
        db.alter_column('ticket_system_ticket', 'cc_mails', self.gf('django.db.models.fields.TextField')(default='aa@aa.com'))
    models = {
        'auth.group': {
