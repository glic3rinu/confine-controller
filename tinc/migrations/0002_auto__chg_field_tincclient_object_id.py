...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tinc_tincclient', 'object_id', self.gf('django.db.models.fields.CharField')(max_length=36))

    def backwards(self, orm):

        # Changing field 'TincClient.object_id'
        db.alter_column('tinc_tincclient', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())
