...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'tinc_gateway', 'cndb_uri')

        # Deleting field 'Gateway.cndb_cached_on'
        db.delete_column(u'tinc_gateway', 'cndb_cached_on')

        # Deleting field 'Gateway.cn_url'
        db.delete_column(u'tinc_gateway', 'cn_url')

        # Adding field 'Gateway.description'
        db.add_column(u'tinc_gateway', 'description',
                      self.gf('django.db.models.fields.CharField')(default='gateway', max_length=256),
                      keep_default=False)


        # Changing field 'Island.name'
        db.alter_column(u'tinc_island', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32))
        # Adding unique constraint on 'Island', fields ['name']
        db.create_unique(u'tinc_island', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Island', fields ['name']
        db.delete_unique(u'tinc_island', ['name'])

        # Adding field 'Gateway.cndb_uri'
        db.add_column(u'tinc_gateway', 'cndb_uri',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Gateway.cndb_cached_on'
        db.add_column(u'tinc_gateway', 'cndb_cached_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gateway.cn_url'
        db.add_column(u'tinc_gateway', 'cn_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'Gateway.description'
        db.delete_column(u'tinc_gateway', 'description')


        # Changing field 'Island.name'
        db.alter_column(u'tinc_island', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))
