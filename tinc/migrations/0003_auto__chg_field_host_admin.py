...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Host.admin'
        db.alter_column(u'tinc_host', 'admin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

    def backwards(self, orm):

        # Changing field 'Host.admin'
        db.alter_column(u'tinc_host', 'admin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
