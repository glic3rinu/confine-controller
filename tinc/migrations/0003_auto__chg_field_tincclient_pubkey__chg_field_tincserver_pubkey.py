...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TincClient.pubkey'
        db.alter_column(u'tinc_tincclient', 'pubkey', self.gf('django.db.models.fields.TextField')(default=None, unique=True))

        # Changing field 'TincServer.pubkey'
        db.alter_column(u'tinc_tincserver', 'pubkey', self.gf('django.db.models.fields.TextField')(default=None, unique=True))
