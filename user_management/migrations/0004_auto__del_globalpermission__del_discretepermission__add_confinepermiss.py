...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('user_management_confinepermission', (
            ...
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_management.Role'], null=True, blank=True)),
    ...
    models = {
        ...
        'user_management.confinepermission': {
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_management.Role']", 'null': 'True', 'blank': 'True'})
        },
