...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConfinePermission.role'
        db.alter_column('user_management_confinepermission', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['user_management.Role']))
    def backwards(self, orm):

        # Changing field 'ConfinePermission.role'
        db.alter_column('user_management_confinepermission', 'role_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_management.Role'], null=True))
    models = {
        'auth.group': {
