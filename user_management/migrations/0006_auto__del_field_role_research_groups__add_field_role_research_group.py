...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Role.research_groups'
        db.delete_column('user_management_role', 'research_groups_id')

        # Adding field 'Role.research_group'
        db.add_column('user_management_role', 'research_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['user_management.ResearchGroup']),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Role.research_groups'
        db.add_column('user_management_role', 'research_groups',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['user_management.ResearchGroup']),
                      keep_default=False)

        # Deleting field 'Role.research_group'
        db.delete_column('user_management_role', 'research_group_id')
    ...
    models = {
        ...
        'user_management.confinepermission': {
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['user_management.Role']"})
        },
