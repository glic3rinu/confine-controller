...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConfinePermission.role'
        db.delete_column('user_management_confinepermission', 'role_id')
    ...
    def backwards(self, orm):
        # Adding field 'ConfinePermission.role'
        db.add_column('user_management_confinepermission', 'role',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['user_management.Role']),
                      keep_default=False)
    ...
    models = {
        ...
        'user_management.confinepermission': {
            ...
            'role': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'permissions'", 'symmetrical': 'False', 'to': "orm['user_management.Role']"})
        },
