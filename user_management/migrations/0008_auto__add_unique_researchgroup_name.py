...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ResearchGroup', fields ['name']
        db.create_unique('user_management_researchgroup', ['name'])

    def backwards(self, orm):
        # Removing unique constraint on 'ResearchGroup', fields ['name']
        db.delete_unique('user_management_researchgroup', ['name'])
