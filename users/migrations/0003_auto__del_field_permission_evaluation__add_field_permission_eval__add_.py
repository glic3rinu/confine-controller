...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Permission.evaluation'
        db.delete_column(u'users_permission', 'evaluation')

        # Adding field 'Permission.eval'
        db.add_column(u'users_permission', 'eval',
                      self.gf('django.db.models.fields.CharField')(default='True', max_length=256),
                      keep_default=False)

        # Adding field 'Permission.eval_description'
        db.add_column(u'users_permission', 'eval_description',
                      self.gf('django.db.models.fields.CharField')(default='True', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Permission.evaluation'
        db.add_column(u'users_permission', 'evaluation',
                      self.gf('django.db.models.fields.CharField')(default='True', max_length=256),
                      keep_default=False)

        # Deleting field 'Permission.eval'
        db.delete_column(u'users_permission', 'eval')

        # Deleting field 'Permission.eval_description'
        db.delete_column(u'users_permission', 'eval_description')
    ...
    models = {
        ...
        u'users.permission': {
            ...
            'eval_description': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
